...
/* Customized rendering logic of TwistSplineNodeNode
 ...
 the procedure geometry (defined by TwistSplineNodeNode::Size) Beside rendering,
 the functions for generating geometry is also a crucial part in Viewport
 Caching (in contrast with Evaluation Caching)
*/
class TwistSplineGeometryOverride : public MPxGeometryOverride {
   ...
   private:
	...
	/* To ensure the plugin works well with Viewport and Evaluation Caching
	 ...
	 - Foreground thread : -- MPxGeometryOverride ------>------ Shader
	 Callback
	   -------->	(Rendering on frame 10)
	 - Background thread : -------- Node Evaluation ----->------
	   MPxGeometryOverride -------> (Viewport cache fill on frame 20)
